 ...
 */
final class Version20230228122425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, coach_id INT DEFAULT NULL, nom_acitivite VARCHAR(255) NOT NULL, description_activite LONGTEXT NOT NULL, duree_activite VARCHAR(255) NOT NULL, date_activite DATE NOT NULL, nbre_place INT NOT NULL, image VARCHAR(255) DEFAULT NULL, time_activite TIME DEFAULT NULL, background_color VARCHAR(7) DEFAULT NULL, border_color VARCHAR(7) DEFAULT NULL, text_color VARCHAR(7) DEFAULT NULL, end TIME DEFAULT NULL, INDEX IDX_B87555153C105691 (coach_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
